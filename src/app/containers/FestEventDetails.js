...
<Row>
<Col xs="12" sm="12"md="12">
<h5 className="festsendtext" ><span style={{color: 'white',padding:'5px'}}>Reach to Fest:</span>{fest_reachus.fest_reach}</h5>
</Col>
<Col xs="12" sm="12"md="12">
<h5 className="festsendtext" ><span style={{color: 'white',padding:'5px'}}>College Location:</span>{fest_reachus.college_location}</h5>
</Col>
<Col xs="12" sm="12"md="12">
<h5 className="festsendtext"><span style={{color: 'white',padding:'5px'}}>Contact Persons:</span>{fest_reachus.Fest_contact_persons}</h5>
</Col>
</Row>
