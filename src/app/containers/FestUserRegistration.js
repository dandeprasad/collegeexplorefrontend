...
UR_NAME:'', UR_EMAIL_ADDRS:'', YOUR_PH_NUMBER:'',CLG_NAME:'',CLG_TYPE:'',CLG_WEBSITE:'',CLG_EMAILID:'',CLG_PH_NUM:'',CLG_LOC:'',HW_REACH:'',
...
CLG_PH_NUM = {this.state.CLG_PH_NUM} CLG_LOC = {this.state.CLG_LOC} HW_REACH = {this.state.HW_REACH}
