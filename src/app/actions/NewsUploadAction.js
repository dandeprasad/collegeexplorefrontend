...
return dispatch =>{
        ...
        axios.post('http://dandereddyprasad.us-east-2.elasticbeanstalk.com/NewsImageUpload', formData, {
            headers: {
...
var dataparse = datatosend
          ...
          axios.post('http://dandereddyprasad.us-east-2.elasticbeanstalk.com/UploadData', dande)
              .then(res => {
