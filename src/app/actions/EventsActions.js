...
return dispatch =>{
    ...
    axios.post('http://dandereddyprasad.us-east-2.elasticbeanstalk.com/FestsHomeAllNotificationsString', datatosend )
      .then(res => {
...
return dispatch =>{
    ...
    axios.post('http://dandereddyprasad.us-east-2.elasticbeanstalk.com/FestsLatestUpdates', datatosend )
      .then(res => {
